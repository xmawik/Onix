...
class AppSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->output->comment('Please reference https://onixmine.ru/panel/1.0/additional_configuration.html#telemetry for more detailed information regarding telemetry data and collection.');
