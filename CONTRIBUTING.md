...
**ONIX does not accept Pull Requests (PRs) _for new functionality_** that was not previously approved by project
...
If you use any type of AI assistance while developing for ONIX **it must be disclosed** within the
