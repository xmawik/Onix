...
return [
    ...
    | Application Version
    |--------------------------------------------------------------------------
    | This value is set when creating an Onix release. You should not
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | ONIX Custom Settings
    |--------------------------------------------------------------------------
    */

    // Text shown in the announcement banner at the top of the admin area.
    // Leave empty (null) to hide the banner. HTML is allowed.
    'announcement' => env('APP_ANNOUNCEMENT', null),

    // Link shown in the "Support" button in the top navigation bar.
